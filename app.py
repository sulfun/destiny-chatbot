...
# ─────────────────────────────────────────────
# 사업자정보 footer (토스 심사 필수)
# ─────────────────────────────────────────────
def show_business_footer():
    st.markdown(
        '<div style="border-top:1px solid #A78BDB22; margin-top:2rem; padding-top:1rem; '
        'text-align:center; color:#A78BDB44; font-size:11px; line-height:1.8;">'
        '(주)술펀 · 대표 이수진<br>'
        '사업자등록번호 117-81-90605<br>'
        '서울 강서구 하늘길 112 김포공항 국내선 A321<br>'
        '전화 02-2272-2789 · 이메일 help@sulfun.com<br>'
        '</div>',
        unsafe_allow_html=True
    )
